...
def getData(series,year):
    ...
    for data in result_data:
        ...
        + "thr_AVG='"+data[1]+"',thr_G='"+data[2]+"',thr_PA='"+data[3]\
        +"',thr_AB='"+data[4]+"',thr_R='"+data[5]+"',thr_H='"+data[6]\
        +"',thr_2B='"+data[7]+"',thr_3B='"+data[8]+"',thr_HR='"+data[9]\
        +"',thr_TB='"+data[10]+"',thr_RBI='"+data[11]\
        +"',thr_SAC='"+data[12]+"',thr_SF='"+data[13]\
        +"',thr_BB='"+data[14]+"',thr_IBB='"+data[15]\
        +"',thr_HBP='"+data[16]+"',thr_SO='"+data[17]\
        +"',thr_GDP='"+data[18]+"',thr_SLG='"+data[19]\
        +"',thr_OBP='"+data[20]+"',thr_OPS='"+data[21]\
