...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/record/player/player_hitter_record_detail.css">
    <script src="/assets/js/record/player/player_hitter_record_detail.js"></script>
</head>
<body>
