    ...
    <div class="contents">
        ...
        <div class="date_pick">
            ...
            <div class="today">
                ...
                <input type="date" id="input_date" class="form-control" aria-describedby="basic-addon1" min=${startDate} max=${today_ranking[0].max_date} value=${today_ranking[0].max_date}>
            </div>
            <div class="btn_right">
